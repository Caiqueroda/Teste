...
namespace Avaliacao.Controllers
{
    public class AlunoesController : Controller
    {
        ...
        public AlunoesController(AvaliacaoContext context)
        {
            _context = context;
        }
        // GET: Alunoes
        ...
        public async Task<IActionResult> Create([Bind("AlunoId,Nome,Idade,Endereco,EnderecoId,CEP,Turma")] Aluno aluno)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AlunoId,Nome,Idade,Endereco,EnderecoId,CEP,Turma")] Aluno aluno)
        {
            if (id != aluno.AlunoId)
            {
                return NotFound();
